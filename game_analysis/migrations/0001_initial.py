# Generated by Django 2.2.3 on 2019-08-01 02:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fog_level', models.ForeignKey(default='NoFog', on_delete=django.db.models.deletion.CASCADE, to='game_analysis.FogLevel')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='primary_territory', to='game_analysis.Territory'),
        ),
        migrations.AddField(
            model_name='order',
            name='secondary_territory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secondary_territory', to='game_analysis.Territory'),
        ),
        migrations.AddField(
            model_name='order',
            name='target_player',
        ...
        migrations.AddField(
            model_name='game',
            name='player_a',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_a', to='game_analysis.Player'),
        ),
        migrations.AddField(
            model_name='game',
            name='player_b',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_b', to='game_analysis.Player'),
        ),
        migrations.AddField(
            model_name='game',
            name='template',
