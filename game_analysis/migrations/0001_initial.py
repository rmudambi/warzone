# Generated by Django 2.2.3 on 2019-08-21 18:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_attack_teammates', models.BooleanField(blank=True, null=True)),
                ('is_attack_by_percent', models.BooleanField(blank=True, null=True)),
                ('order_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_analysis.OrderType')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player', to='game_analysis.Player')),
                ('primary_territory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='primary_territory', to='game_analysis.Territory')),
                ('secondary_territory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='secondary_territory', to='game_analysis.Territory')),
                ('target_bonus', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='game_analysis.Bonus')),
                ('target_player', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='target_player', to='game_analysis.Player')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_analysis.Order', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='TerritoryState',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('end_state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_analysis.PlayerState')),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_analysis.Game')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_analysis.Player')),
            ],
            options={
