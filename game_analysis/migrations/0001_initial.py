# Generated by Django 2.2.3 on 2019-09-11 01:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255)),
                ('games', models.ManyToManyField(through='game_analysis.GamePlayer', to='game_analysis.Game')),
            ],
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AddField(
            model_name='order',
            name='player',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='game_analysis.GamePlayer'),
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AddField(
            model_name='order',
            name='target_player',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='game_analysis.GamePlayer'),
        ),
        migrations.AddField(
            model_name='order',
            name='turn',
        ...
        migrations.AddField(
            model_name='gameplayer',
            name='player',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_analysis.Player'),
        ),
        migrations.AddField(
            model_name='game',
            name='ladder',
        ...
        migrations.AddField(
            model_name='game',
            name='players',
            field=models.ManyToManyField(through='game_analysis.GamePlayer', to='game_analysis.Player'),
        ),
        migrations.AddField(
            model_name='game',
            name='template',
