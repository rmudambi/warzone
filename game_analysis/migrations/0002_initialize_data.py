# Generated by Django 2.2.3 on 2019-09-09 20:52
...
def generate_player_state_types(apps, schema_editor):
    ...
    player_states = [
        ...
        PlayerStateType(id='RemovedByHost'),
        PlayerStateType(id='EndedByVote'),
        PlayerStateType(id='Eliminated'),
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(generate_player_state_types),
    ]
